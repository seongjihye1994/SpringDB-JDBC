...
/**
 * JDBC - Connection 을 파라미터로 넘기는 예제
 */
@Slf4j
public class MemberRepositoryV2 {
    ...
    /**
     * Connection 을 파라미터로 받는 findById 메소드
     *
     * @param con
     * @param memberId
     * @return
...
//            JdbcUtils.closeConnection(con); // 커넥션을 리포지토리에서 닫는게 아니라, 서비스 로직에서 닫도록 처리해야 한다!!!! -> db 커넥션 세션 유지를 위해!!!!
        }
    }
    ...
    /**
     * Connection 을 파라미터로 받는 update 메소드
     * @param memberId
     * @param money
     * @throws SQLException
     */
